...
export default function DeleteMessageModal({ isOpen, onClose, message, onConfirm }) {
  ...
  return (
    ...
    >
      {/* Backdrop */}
      <div 
        className="absolute inset-0 bg-[#007ce1]/40 backdrop-blur-sm transition-opacity duration-300 ease-out"
        onClick={onClose}
      />
      ...
      >
        <div className="p-6 text-center">
            ...
            <p className="text-gray-500 mb-6 text-sm">
                Are you sure you want to delete the message from <span className="font-semibold text-black">{message?.sender}</span>? This action cannot be undone.
            </p>
